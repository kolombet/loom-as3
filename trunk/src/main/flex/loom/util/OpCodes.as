...
{
	/**
	 * This class is being held for reference and will ultimately be deleted. It contains the opcode definitions from
	 * abcdump.as in the Tamarin project. 
	 * 
	 * @private
	 */
	public class OpCodes
	{
		public static const OP_NAMES : Array = [
	    "OP_0x00       ",
	    "bkpt          ",
	    "nop           ",
	    "throw         ",
